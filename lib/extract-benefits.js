  ...
  "benefits": [
    {
      ...
      "merchants_or_scope": "적용 가맹점/범위 (가급적 널리 쓰이는 대표 브랜드명으로 정규화해서 추출하되(예: '아웃백스테이크하우스' -> '아웃백'), 확신이 서지 않는다면 원문을 그대로 유지하세요. 여러 개면 | 로 구분) 또는 null",
  ...
  "merchant_normalization_flags": [
    {
      ...
      "normalized": "정규화한 대표명 (정규화하지 못했으면 original과 동일하게 작성)",
