...

{
  ...
  "benefits": [
    {
      "benefit_name": "혜택명",
      "category": "다음 목록 중 정확히 하나만 선택 (목록 밖 값이나 여러 개를 |로 이어붙이는 것 금지, 가장 가까운 것 하나만 고를 것): 카페 | 편의점 | 외식 | 배달 | 영화 | 구독 | 통신 | 교통 | 택시 | 대형마트 | 주유 | 온라인쇼핑 | 의료 | 도서 | 패션 | 뷰티 | 테마파크 | 여행 | 면세점 | 공과금 | 쇼핑 | 문화 | 해외 | 간편결제 | 기타 | 교육 | 항공 | 금융 | 렌탈",
