...
const CANONICAL_CATEGORIES = new Set([
  "카페", "편의점", "외식", "배달", "영화", "구독", "통신", "교통", "택시",
  "대형마트", "주유", "온라인쇼핑", "의료", "도서", "패션", "뷰티", "테마파크",
  "여행", "면세점", "공과금", "쇼핑", "문화", "해외", "간편결제", "기타",
  "교육", "항공", "금융", "렌탈",
]);
...
function buildPayload({ extracted, provider, productName, productId, sourceId, documentHash, fileName, aliasMatchType, note, sourceUrl, sourceType = "PDF" }) {
  const product = {
    ...extracted.product,
    provider,
